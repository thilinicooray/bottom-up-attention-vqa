...
def main():
    ...
    dev_set = imsitu_loader_verb_buatt_iter(imgset_folder, dev_set, encoder, 'val', encoder.dev_transform)
    ...
    if args.use_pretrained_buatt:
        ...
        utils_imsitu.load_net_ban(args.pretrained_buatt_model, [model], ['module'], ['conv_net', 'w_emb', 'q_emb', 'classifier'])
