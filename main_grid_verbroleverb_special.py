        ...
        for i, (img_id, v_img, r_img, verb, labels) in enumerate(train_loader):
            ...
            if total_steps % eval_frequency == 0:
                ...
                if max_score == dev_score_list[-1]:
                    torch.save(model.state_dict(), model_dir + "/{}_verbroleverb_special_{}.model".format( model_name, model_saving_name))
...
def main():
    ...
    parser.add_argument('--model', type=str, default='baseline0grid_imsitu_verbroleverb_special')
