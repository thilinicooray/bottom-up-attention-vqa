...
def main():
    ...
    parser.add_argument('--model', type=str, default='baseline0grid_imsitu_roleverb_general_with_cnn_extctx')
    ...
    if args.use_pretrained_buatt:
        ...
        opts = [{'params': model.convnet.parameters(), 'lr': 5e-5},
                ...
                {'params': model.rep_ctx_project.parameters()},
                {'params': model.combo_after_gating.parameters()},
