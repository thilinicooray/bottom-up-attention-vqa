...
if __name__ == '__main__':
    ...
    d.dump_to_file('data/dictionary_imsitu_rolenames.pkl')

    d = Dictionary.load_from_file('data/dictionary_imsitu_rolenames.pkl')
    emb_dim = 300
    glove_file = 'data/glove/glove.6B.%dd.txt' % emb_dim
    weights, word2emb = create_glove_embedding_init(d.idx2word, glove_file)
    np.save('data/glove6b_init_imsitu_rolenames%dd.npy' % emb_dim, weights)
