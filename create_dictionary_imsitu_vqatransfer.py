...
def create_dictionary(dataroot):
    ...
    imsitu_words_path = os.path.join(dataroot, 'allnverbs_imsitu_words_nl2vqamatching.json')
...
if __name__ == '__main__':
    ...
    d.dump_to_file('data/dictionary_vqa_imsitu_both.pkl')

    d = Dictionary.load_from_file('data/dictionary_vqa_imsitu_both.pkl')
    emb_dim = 300
    glove_file = 'data/glove/glove.6B.%dd.txt' % emb_dim
    weights, word2emb = create_glove_embedding_init(d.idx2word, glove_file)
    np.save('data/glove6b_init_vqa_imsitu_both_%dd.npy' % emb_dim, weights)
